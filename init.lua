...
do
  ...
  vim.api.nvim_create_autocmd('PackChanged', {
    callback = function(ev)
      ...
      -- Markdown/Mermaid browser preview: download its prebuilt binary on install/update.
...
do
  ...
  vim.list_extend(ensure_installed, {
    -- Formatters (used by conform.nvim above)
    'stylua', -- Lua
    'prettierd', -- JS/TS/HTML/CSS/JSON/YAML/Markdown
    'black', -- Python
    'isort', -- Python imports
    -- Note: rustfmt and gofmt ship with the rust/go toolchains, so they are not installed here.
  })
...
do
  ...
  require('conform').setup {
    ...
    formatters_by_ft = {
      ...
      rust = { 'rustfmt' },
      go = { 'gofmt' },
      -- Use the first available formatter from the list for web files
...
do
  ...
  require 'kickstart.plugins.neo-tree' -- file explorer (\ to toggle)
